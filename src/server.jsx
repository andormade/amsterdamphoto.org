...
routes.forEach(route => {
	...
	urlset.push(`<url><loc>https://amsterdamphoto.org${routePath}</loc></url>`);
	...
	const content = `<!DOCTYPE html>
		<html>
			<head>
				...
				<meta property="og:url" content="https://amsterdamphoto.org${routePath}" />
				<link rel="canonical" href="https://amsterdamphoto.org${routePath}" />
